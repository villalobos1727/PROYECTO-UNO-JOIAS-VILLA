        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="imagens/32498_2.webp">
                    <div class="card-body">
                        <h3 class="card-text">colar longo</h3>
                        <h4>R$ 50,00</h4>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">colar longo</h5>
      ...
      <div class="modal-body">
            ...
            <img class="img-fluid" src="imagens/32498_2.webp">
