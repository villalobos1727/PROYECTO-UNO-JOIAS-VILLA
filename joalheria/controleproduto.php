<?php
   ...
   // var_dump($dadosprod);
    ...
    if (!$vazio) {
            ...
            $sql = "INSERT INTO produto(nome,valor,quantidade,idcategoria,foto)
        VALUES(:nome,:valor,:quantidade,:idcategoria,:foto)";
...
if (!empty($dadosprod['btneditar'])) {
   ...
   quantidade=:quantidade,idcategoria=:idcategoria,foto=:foto 
